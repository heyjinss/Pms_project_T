...
//1. 권한 설정 (PM일 경우에만 삭제/수정/추가 버튼 활성화 )
...
//2. (모달창) 부서번호 selectbox 검색처리 - 멤버 목록(추가 시)	
						...
						<div class="card-body">
							<div class="chart-pie pt-4">
								<button class="btn btn-success btn-icon-split"
									data-toggle="modal" data-target="#exampleModalCenter" id="ad">구성원추가</button>
									...
									<c:forEach var="memdetail" items="${memdetail}">
										<tr>
											...
											<td><button data-toggle="modal"
													data-target="#exampleModalCenter1" id="ch"
													class=" badge rounded-pill bg-dark ch"
													onclick="changeA('${memdetail.mem_no}')">변경</button></td>
											<td><button id="del"
													class=" badge rounded-pill bg-dark del"
													onclick="deleteA('${memdetail.mem_no}','${memdetail.pro_no}')">
													삭제</button></td>
										</tr>
									</c:forEach>
								</table>
		...
		<div class="modal-dialog2 modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="regFrm" class="form" action="${path}/memberupt2.do"
						method="post">
						<input type="hidden" value="" name="pro_no" /> <input
							type="hidden" value="" name="emp_no" id="emp_no2" />
					</form>
					<!-- First Column -->
					<div class="col-lg-4">
		...
		<div class="modal-dialog2 modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="delReg" class="btn btn-secondary"
						data-dismiss="modal">삭제</button>
					<button type="button" id="btnReg" onclick="changeB()"
