				...
				<div class="container-fluid">
					...
					<ol class="breadcrumb" id="pagePath">
						...
						<li class="breadcrumb-item active"><a
							href="${path}/proDetail.do?pro_no=${prodetail.pro_no}">프로젝트 상세</a></li>
					</ol>
					<div class="row"></div>
					<!-- Content Row -->
					<div class="row">
						...
						<div class="col-xl-4 col-lg-5">
							<div class="card shadow mb-4">
								...
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">프로젝트 멤버 정보</h6>
								</div>
								<!-- Card Body -->
								<div class="card-body">
									<div class="chart-pie pt-4">
										<div class="tot">
											외 ${memtot}명 &nbsp <a href="#" id="uptbtn"
												class="badge bg-dark"> 더보기</a>
										</div>
